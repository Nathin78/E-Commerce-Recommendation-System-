    ...
    <Container sx={{ py: { xs: 2, md: 3 }, px: { xs: 1, sm: 2, md: 3 } }}>
      ...
      >
        <Stack direction={{ xs: "column", md: "row" }} justifyContent="space-between" spacing={2}>
          <Box>
            <Typography variant="h4" sx={{ fontWeight: 900, mb: 0.5 }}>My Cart</Typography>
      ...
      {message ? <Alert sx={{ mb: 2 }} severity="info">{message}</Alert> : null}
            ...
            {cart?.items?.map((item, index) => (
              ...
              >
                <Stack direction={{ xs: "column", md: "row" }} divider={<Divider orientation="vertical" flexItem sx={{ display: { xs: "none", md: "block" } }} />}>
                  ...
                  <Box sx={{ width: { xs: "100%", md: 280 }, p: { xs: 1.8, md: 2.1 }, bgcolor: theme.palette.mode === "dark" ? "rgba(248,250,252,0.02)" : "#fbfcff" }}>
                    <Stack spacing={1.2}>
        ...
        <Box sx={{ width: { xs: "100%", xl: 360 }, flexShrink: 0 }}>
          <Stack spacing={2} sx={{ position: { xl: "sticky" }, top: { xl: 92 } }}>
            <Paper sx={{ p: 2.2, borderRadius: 3, border: `1px solid ${theme.palette.divider}` }}>
              <Typography variant="h6" sx={{ fontWeight: 800 }}>Offers & Coupons</Typography>
            ...
            <Paper sx={{ p: 2.2, borderRadius: 3, border: `1px solid ${theme.palette.divider}` }}>
              <Typography variant="h6" sx={{ fontWeight: 800, mb: 1.4 }}>Price Details</Typography>
              <Stack spacing={1.1}>
